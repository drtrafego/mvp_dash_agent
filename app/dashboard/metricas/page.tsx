                ...
                <div className="bg-white rounded-2xl border border-gray-200 p-5">
                    ...
                    <ResponsiveContainer width="100%" height={200}>
                        <PieChart>
                            ...
                            <Legend iconSize={10} wrapperStyle={{ fontSize: 11 }} />
                            <Tooltip formatter={(v: unknown) => [String(v ?? ""), "Conversas"]} />
                        </PieChart>
                    </ResponsiveContainer>
                </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-5">
                ...
                <ResponsiveContainer width="100%" height={160}>
                    <BarChart data={charts.leadFunnel} layout="vertical" margin={{ top: 0, right: 20, bottom: 0, left: 60 }}>
                        ...
                        <Tooltip formatter={(v: unknown) => [String(v ?? ""), "Leads"]} contentStyle={{ borderRadius: "10px", border: "1px solid #e2e8f0", fontSize: 12 }} />
